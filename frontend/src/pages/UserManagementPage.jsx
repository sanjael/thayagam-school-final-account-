...
function TempPasswordModal({ data, onClose }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center px-4">
      <div className="bg-[#0a0f1e] border border-amber-500/20 rounded-2xl p-8 w-full max-w-md shadow-2xl">
...
function CreateUserModal({ onClose, onCreated }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center px-4">
      <div className="bg-[#0a0f1e] border border-white/10 rounded-2xl p-8 w-full max-w-md shadow-2xl">
      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-slate-500 text-sm mt-1">Create and manage staff accounts for this system.</p>
          </div>
          <button
            onClick={() => setShowCreate(true)}
            className="flex items-center gap-2 bg-amber-500 hover:bg-amber-400 text-slate-900 font-bold px-5 py-2.5 rounded-xl text-sm transition shadow-lg shadow-amber-500/20"
          >
